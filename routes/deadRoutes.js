...
router.post('/update-floor', deedController.updateAllFloors);

/**
 * @route GET /api/deeds/floor-stats
 * @description Get statistics about floor distribution
 * @access Private
 */
router.get('/floor-stats', deedController.getFloorStats);

/**
 * @route GET /api/deeds/floor/:floor
 * @description Get deeds by floor number
 * @access Private
 */
router.get('/floor/:floor', deedController.getDeedsByFloor);
